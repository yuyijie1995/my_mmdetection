...
BASE_DIR='/media/wrc/0EB90E450EB90E45/mmdetection/data/coco/test2017'
...
def parse_args():
    ...
    parser.add_argument('--gt',help='ground truth results json',default='./data/coco/annotations/instances_test2017.json')
    parser.add_argument('--metric',default='voc')
    parser.add_argument('--th',help='iou_threshold',type=float,default=0.5)
    parser.add_argument('--img_dir',help='the images used to predict',default='./data/coco/val2017/')
    parser.add_argument('--save_dir',help='save the fp&fn target image fragment',default='./save_eval/')
    parser.add_argument('--save',help='save the fp&fn target image fragment or not',type=bool,default=False)
